...
export const deleteUserAction = authenticatedActionClient.schema(z.unknown()).action(
  withAuditLogging(
    "deleted",
    "user",
    async ({ ctx, parsedInput }: { ctx: AuthenticatedActionClientCtx; parsedInput: unknown }) => {
